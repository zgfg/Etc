...
<!--
- `sDebloater-config.txt`
- `SystemlessDebloaterList.sh`

_`sDebloater_config` will take precedence if multiple config files are found._
-->
...
- and his [Examples](https://github.com/mModule/guide_sDebloater/wiki/CommunityList) of apps that can be debloated (**Android**, **Google**, **Oppo**, **Samsung**, **Xiaomi**, **LineageOS**)_
-->
